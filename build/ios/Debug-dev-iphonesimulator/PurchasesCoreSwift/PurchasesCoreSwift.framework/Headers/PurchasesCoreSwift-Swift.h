...
@property (nonatomic, readonly, copy) NSString * _Nonnull search_ads_attribution_cancelled_missing_ad_framework;
...
@property (nonatomic, readonly, copy) NSString * _Nonnull creating_alias_with_nil_appuserid;
...
@property (nonatomic, readonly, copy) NSString * _Nonnull configuration_error_skproducts_not_found;
@property (nonatomic, readonly, copy) NSString * _Nonnull configuration_error_no_products_for_offering;
@property (nonatomic, readonly, copy) NSString * _Nonnull offering_empty;
@property (nonatomic, readonly, copy) NSString * _Nonnull skproductsrequest_timed_out;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
- (void)dispatchOnWorkerThreadAfterDelayInSeconds:(NSInteger)delayInSeconds block:(void (^ _Nonnull)(void))block;
@end
...
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, copy) NSString * _Nonnull airshipChannelID;)
+ (NSString * _Nonnull)airshipChannelID SWIFT_WARN_UNUSED_RESULT;
